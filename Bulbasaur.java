...
<<<<<<< HEAD
  public Bulbasaur(int level,ArrayList<Move> moveset,Stats bulbaStats,int xp, double genRatio, String gender, String debuff)
  {
    super("Bulbasaur", 2.04, 15.2, "A strange seed was planted on its back at birth. The plant sprouts and grows with this pokemon.", 001, Pokemon.getParticularType("Grass/Poison"), level, moveset,bulbasaurMoves,xp,bulbaStats, Stats.getPokemonStat("Bulbasaur"),genRatio,gender, debuff);
  }
...
=======
  ...
  {
    Move tackle = Move.tackle(1);
>>>>>>> fd2f14ef1c908b3f54d993b7632ab8e3cbebd53a
